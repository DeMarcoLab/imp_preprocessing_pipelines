...
export const collections: { tomosets?: mongoDB.Collection } = {};
...
export async function connectToDatabase() {
    ...
    const bioCollection: mongoDB.Collection = db.collection(process.env.COLLECTION_NAME);

    // Persist the connection to the Tomosets collection
    collections.tomosets = bioCollection;

    console.log(
        `Successfully connected to database: ${db.databaseName} and collection: ${bioCollection.collectionName}`,
    );
}
